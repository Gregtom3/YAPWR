...
BinMigrationProcessor::MigrationData
BinMigrationProcessor::loadData(const std::string& moduleOutDir) const
{
    ...
    for (const auto& c : root["primary_section"]
                         [d.pion_pair]
                         ["cuts"])
    {
